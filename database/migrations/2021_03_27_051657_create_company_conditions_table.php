...
class CreateCompanyConditionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('company_conditions', function (Blueprint $table) {
            $table->increments("iCompanyContidionId");
            $table->integer("iCompanyMasterId")->unsigned();
            $table->text("txCondition");
    ...
    {
        Schema::dropIfExists('company_conditions');
    }
}
